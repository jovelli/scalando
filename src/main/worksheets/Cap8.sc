...
import com.jovelli.scalando.MediaCap7
...
object Cap8 {
  ...
  def printaSetMedias[T <: MediaCap7](medias: Set[T]) = medias.foreach(println)
                                                  //> printaSetMedias: [T <: com.jovelli.scalando.MediaCap7](medias: Set[T])Unit
  ...
  printaSetMedias(setVideos)                      //> VideoCap7(1,PrimeiroVideo)
	...
	def printListMedias(medias: List[MediaCap7]) = medias.foreach(println)
                                                  //> printListMedias: (medias: List[com.jovelli.scalando.MediaCap7])Unit
